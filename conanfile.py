...
class ImfToolConan(ConanFile):
    ...
    # ---Requirements---
    requires = ("qt/6.8.2@de.privatehive/stable", "qtappbase/1.6.0@de.privatehive/stable", "photon/4.10.8@de.privatehive/stable", "regxmllib/1.1.4", "asdcplib/2.13.1", "xerces-c/3.2.5", "openjpeg/2.5.2", "zlib/1.3.1")
