...
class ImfToolConan(ConanFile):
    ...
    # ---Requirements---
    requires = ("qt/6.8.2@de.privatehive/stable", "qtappbase/1.7.0@de.privatehive/stable", "photon/4.10.8@imftool/stable", "regxmllib/1.1.5@imftool/stable", "asdcplib/2.13.1@imftool/stable", "xerces-c/3.2.5", "openjpeg/2.5.2", "zlib/1.3.1")
