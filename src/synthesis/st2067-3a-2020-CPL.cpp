...
namespace cpl2016
{
  ...
  TrackFileResourceType::HashAlgorithmOptional& TrackFileResourceType::
  getHashAlgorithm ()
  {
    return this->HashAlgorithm_;
  }
...
namespace cpl2016
{
         ...
         ::xml_schema::Flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // TimecodeDropFrame
      //
      if (n.name () == "TimecodeDropFrame" && n.namespace_ () == "http://www.smpte-ra.org/schemas/2067-3/2016")
      {
      ...
      // TimecodeRate
      //
      if (n.name () == "TimecodeRate" && n.namespace_ () == "http://www.smpte-ra.org/schemas/2067-3/2016")
      {
         ...
         ::xml_schema::Flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // any
      //
      if ((!n.namespace_ ().empty () && n.namespace_ () != "http://www.smpte-ra.org/schemas/2067-3/2016"))
      {
         ...
         ::xml_schema::Flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // IntrinsicDuration
      //
      if (n.name () == "IntrinsicDuration" && n.namespace_ () == "http://www.smpte-ra.org/schemas/2067-3/2016")
      {
      ...
      // EntryPoint
      //
      if (n.name () == "EntryPoint" && n.namespace_ () == "http://www.smpte-ra.org/schemas/2067-3/2016")
      {
        if (!this->EntryPoint_)
        {
      ...
      // SourceDuration
      //
      if (n.name () == "SourceDuration" && n.namespace_ () == "http://www.smpte-ra.org/schemas/2067-3/2016")
      {
      ...
      // RepeatCount
      //
      if (n.name () == "RepeatCount" && n.namespace_ () == "http://www.smpte-ra.org/schemas/2067-3/2016")
      {
         ...
         ::xml_schema::Flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // Offset
      //
      if (n.name () == "Offset" && n.namespace_ () == "http://www.smpte-ra.org/schemas/2067-3/2016")
      {
        if (!Offset_.present ())
        {
...
namespace cpl2016
{
  ...
  serializeCompositionPlaylist (::std::ostream& o,
                                const ::cpl2016::CompositionPlaylistType& s,
                                ...
                                ::xml_schema::Flags f)
  {
    ...
    ::cpl2016::serializeCompositionPlaylist (*d, s, f);
    return d;
  }
  ...
  operator<< (::xercesc::DOMElement& e, const MarkerResourceType& i)
  {
    ...
    for (MarkerResourceType::MarkerConstIterator
         ...
         b != n; ++b)
    {
      const MarkerResourceType::MarkerType& x (*b);
  ...
  operator<< (::xercesc::DOMElement& e, const CompositionPlaylistType_ContentVersionListType& i)
  {
    ...
    for (CompositionPlaylistType_ContentVersionListType::ContentVersionConstIterator
         ...
         b != n; ++b)
    {
      const CompositionPlaylistType_ContentVersionListType::ContentVersionType& x (*b);
  ...
  operator<< (::xercesc::DOMElement& e, const CompositionPlaylistType_EssenceDescriptorListType& i)
  {
    ...
    for (CompositionPlaylistType_EssenceDescriptorListType::EssenceDescriptorConstIterator
         ...
         b != n; ++b)
    {
      const CompositionPlaylistType_EssenceDescriptorListType::EssenceDescriptorType& x (*b);
  ...
  operator<< (::xercesc::DOMElement& e, const CompositionPlaylistType_LocaleListType& i)
  {
    ...
    for (CompositionPlaylistType_LocaleListType::LocaleConstIterator
         ...
         b != n; ++b)
    {
      const CompositionPlaylistType_LocaleListType::LocaleType& x (*b);
  ...
  operator<< (::xercesc::DOMElement& e, const CompositionPlaylistType_SegmentListType& i)
  {
    ...
    for (CompositionPlaylistType_SegmentListType::SegmentConstIterator
         ...
         b != n; ++b)
    {
      const CompositionPlaylistType_SegmentListType::SegmentType& x (*b);
  ...
  operator<< (::xercesc::DOMElement& e, const LocaleType_LanguageListType& i)
  {
    ...
    for (LocaleType_LanguageListType::LanguageConstIterator
         ...
         b != n; ++b)
    {
      const LocaleType_LanguageListType::LanguageType& x (*b);
  ...
  operator<< (::xercesc::DOMElement& e, const LocaleType_RegionListType& i)
  {
    ...
    for (LocaleType_RegionListType::RegionConstIterator
         ...
         b != n; ++b)
    {
      const LocaleType_RegionListType::RegionType& x (*b);
  ...
  operator<< (::xercesc::DOMElement& e, const LocaleType_ContentMaturityRatingListType& i)
  {
    ...
    for (LocaleType_ContentMaturityRatingListType::ContentMaturityRatingConstIterator
         ...
         b != n; ++b)
    {
      const LocaleType_ContentMaturityRatingListType::ContentMaturityRatingType& x (*b);
  ...
  operator<< (::xercesc::DOMElement& e, const SequenceType_ResourceListType& i)
  {
    ...
    //
    {
      ...
      for (SequenceType_ResourceListType::ResourceConstIterator
           ...
           b != n; ++b)
      {
        const SequenceType_ResourceListType::ResourceType& x (*b);

        if (typeid (SequenceType_ResourceListType::ResourceType) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "Resource",
